...
public class AmbilWarnaPreference extends Preference {
	...
	public AmbilWarnaPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
		setWidgetLayoutResource(com.gallantrealm.myworld.android.R.layout.ambilwarna_pref_widget);
	}
	...
	/*
	 * Suppose a client uses this preference type without persisting. We must save the instance state so it is able to,
	 * for example, survive orientation changes.
	 */
	@Override
